export const adminContentGenerationMessages = {
  en: {
    ...
    "admin.contentGeneration.model.flashLite.label":
      "Gemini 3.1 Flash-Lite · Economical",
    ...
    "admin.contentGeneration.model.proPreview.label":
    ...
    "admin.contentGeneration.success":
      "English content was generated. Review it before saving.",
  ...
  vi: {
    ...
    "admin.contentGeneration.model.proPreview.label":
      "Gemini 3.1 Pro Preview · Chất lượng cao",
    "admin.contentGeneration.model.proPreview.description":
    ...
    "admin.contentGeneration.sourceRequired":
      "Nhập tên tiếng Việt trước khi tạo nội dung English.",
    "admin.contentGeneration.reviewNotice":
    ...
    "admin.contentGeneration.success":
      "Đã tạo nội dung English. Hãy kiểm tra trước khi lưu.",
    "admin.contentGeneration.failed":
