    ...
    },
    {
      ...
      groups: [
        ...
        makeGroup(labels.knitwear, [
          ...
          { vi: "Áo cổ lọ", en: "Turtlenecks", categories: ["ao"], qVi: "cổ lọ", qEn: "turtleneck" },
        ]),
        makeGroup(labels.jackets, [
          { vi: "Tất cả áo khoác", en: "All outerwear", categories: ["ao-khoac"] },
          { vi: "Blazer & Suit", en: "Blazers & Suits", categories: ["ao-khoac"], qVi: "blazer", qEn: "blazer" },
          { vi: "Trench & Overcoat", en: "Trench & Overcoats", categories: ["ao-khoac"], qVi: "trench", qEn: "trench" },
          { vi: "Bomber & Parka", en: "Bombers & Parkas", categories: ["ao-khoac"], qVi: "bomber", qEn: "bomber" },
        ]),
      ],
    },
    {
      ...
      groups: [
        makeGroup(labels.trousersGroup, [
          ...
          { vi: "Quần tây", en: "Tailored trousers", categories: ["quan"], qVi: "quần tây", qEn: "tailored" },
          { vi: "Quần linen", en: "Linen trousers", categories: ["quan"], qVi: "linen", qEn: "linen" },
          { vi: "Quần khaki & Chinos", en: "Chinos & Khakis", categories: ["quan"], qVi: "chinos", qEn: "chinos" },
          { vi: "Quần jeans", en: "Jeans", categories: ["quan"], qVi: "jeans", qEn: "jeans" },
        ]),
        makeGroup(labels.trousersFitGroup, [
          { vi: "Ống rộng", en: "Wide leg", categories: ["quan"], qVi: "ống rộng", qEn: "wide leg" },
          { vi: "Ống suông", en: "Straight fit", categories: ["quan"], qVi: "ống suông", qEn: "straight fit" },
          { vi: "Slim fit", en: "Slim fit", categories: ["quan"], qVi: "slim fit", qEn: "slim fit" },
    ...
    },
    {
      ...
      groups: [
        makeGroup(labels.skirts, [
          ...
          { vi: "Váy bút chì", en: "Pencil skirts", categories: ["vay"], qVi: "bút chì", qEn: "pencil" },
        ]),
        makeGroup(labels.dressesGroup, [
          ...
          { vi: "Jumpsuit", en: "Jumpsuits", categories: ["dam"], qVi: "jumpsuit", qEn: "jumpsuit" },
        ]),
      ],
    },
    {
      ...
      groups: [
        makeGroup(labels.shoes, [
          ...
          { vi: "Derby, Oxford & Loafer", en: "Derby, Oxford & Loafers", categories: ["giay"], qVi: "da", qEn: "leather" },
          { vi: "Sneaker & Slip-on", en: "Sneakers & Slip-ons", categories: ["giay"], qVi: "sneaker", qEn: "sneaker" },
          { vi: "Sandal & Mule", en: "Sandals & Mules", categories: ["giay"], qVi: "sandal", qEn: "sandal" },
        ]),
        makeGroup(labels.accessoriesGroup, [
          ...
          { vi: "Móc khóa", en: "Key hooks", categories: ["phu-kien"], qVi: "móc khóa", qEn: "key hook" },
        ]),
      ],
    },
