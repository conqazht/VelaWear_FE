  ...
  return (
    <div className="grid gap-4 md:grid-cols-2" aria-hidden="true">
      {Array.from({ length: 2 }).map((_, index) => (
        <div key={index} className="border-hairline/45 min-h-36 rounded-md border bg-white p-5">
...
export function ProfileOverviewLoading() {
  return (
    <div
      className="mt-2 flex flex-col gap-12 text-left md:flex-row md:gap-40 lg:gap-56"
      aria-hidden="true"
    >
      ...
      <div className="w-full max-w-2xl space-y-8">
        ...
        <div className="border-hairline flex justify-end border-t pt-8">
  ...
  return (
    <div className="flex flex-col gap-8" aria-hidden="true">
      {Array.from({ length: 3 }).map((_, index) => (
        <div
          key={index}
          className="border-hairline/60 bg-surface-card/30 flex flex-col justify-between gap-6 rounded-sm border p-6 md:flex-row"
        >
          ...
          <div className="border-hairline/40 flex flex-row items-center justify-between gap-3 border-t pt-4 md:flex-col md:items-end md:justify-center md:border-t-0 md:pt-0">
            <Skeleton className="h-4 w-24" />
  ...
  return (
    ...
    >
      {Array.from({ length: 4 }).map((_, index) => (
        <div
          key={index}
          className="h-full overflow-hidden rounded-md border border-transparent bg-white"
        >
          <div className="relative aspect-square">
            <Skeleton className="absolute inset-0 size-full rounded-none" />
            <Skeleton className="absolute top-4 right-4 size-8 rounded-full bg-white/80" />
          </div>
          <div className="flex flex-col items-start px-4 pt-5 pb-6">
