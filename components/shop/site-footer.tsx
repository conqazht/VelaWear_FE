...
export function SiteFooter() {
  return (
    <footer className="mt-auto bg-[#1c1a18] px-6 py-16 text-[#f7f4ef] md:px-12">
      ...
      <div className="mx-auto mt-12 flex max-w-7xl flex-col items-center justify-between gap-4 border-t border-white/10 pt-6 text-[10px] tracking-wider text-white/40 md:flex-row">
