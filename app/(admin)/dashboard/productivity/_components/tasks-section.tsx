...
const tasks: Task[] = [
  {
    titleKey: "admin.productivity.tasks.roadmap",
    tagKey: "admin.productivity.tag.work",
    hour: 10,
    minute: 0,
    checked: false,
  },
  {
    titleKey: "admin.productivity.tasks.design",
    tagKey: "admin.productivity.tag.design",
    hour: 11,
    minute: 30,
    checked: true,
  },
  {
    titleKey: "admin.productivity.tasks.emails",
    tagKey: "admin.productivity.tag.admin",
    hour: 14,
    minute: 0,
    checked: false,
  },
  {
    titleKey: "admin.productivity.tasks.content",
    tagKey: "admin.productivity.tag.content",
    hour: 16,
    minute: 30,
    checked: false,
  },
  {
    titleKey: "admin.productivity.tasks.notes",
    tagKey: "admin.productivity.tag.planning",
    hour: 18,
    minute: 0,
    checked: false,
  },
                ...
                <div className="min-w-0 flex-1">
                  <div className="flex flex-col gap-3 lg:flex-row lg:items-center lg:justify-between">
                    ...
                    <div className="text-muted-foreground flex shrink-0 items-center gap-3 text-sm">
                      <span>
                        {formatDate(new Date(2024, 3, 15, task.hour, task.minute), locale, {
                          hour: "numeric",
                          minute: "2-digit",
                        })}
                      </span>
